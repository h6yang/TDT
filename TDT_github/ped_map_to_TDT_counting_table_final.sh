...
# the final output of this shell script is "tdt_count_output.txt" 
...
# use plink to calculate b and c
 ./plink --file ${PREFIX} --tdt   --out rsxxxxxxx --noweb --allow-no-sex
 # remove the header 
...
# for loop calculate all snps
 ...
 paste ${PREFIX}.map fam_genotype_pattern.temp > tdt_count_output.txt
